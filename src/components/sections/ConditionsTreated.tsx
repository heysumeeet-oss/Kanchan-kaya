  ...
  const conditions = [
    ...
    },
    {
      ...
      items: [
        ...
        "Pregnancy Wellness and Postnatal Care",
      ],
    },
    {
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-16">
          <h2 className="text-3xl font-bold tracking-tight text-green-950 sm:text-4xl mb-6">
            Health Conditions We Treat at Kanchankaya Naturopathy Center Lucknow
          </h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {conditions.map((group, index) => (
            ...
            >
              <h3 className="text-lg font-bold text-green-900 mb-4 border-b border-green-200 pb-2 min-h-[3.5rem] flex items-center">
                {group.category}
              </h3>
